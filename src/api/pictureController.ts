...
/** refreshPictureListCache POST /api/picture/admin/cache/refreshPictureList */
export async function refreshPictureListCacheUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVO_>('/api/picture/admin/cache/refreshPictureList', {
    method: 'POST',
    headers: {
...
/** listPictureByPageWithCache POST /api/picture/list/page/vo/cache */
